...
function togglePlayAllTracks() {
  ...
  if (isPlaying) {
    ...
    playBtn.innerHTML = `
      <img src="play-icon.png" width="20" height="20"
           style="margin-left:4px;vertical-align:middle;" alt="Play All">
    `;
  } else {
    // --- PLAY ALL ---
    let longest = 0, buffers = {};

    // fetch & decode all tracks
    Promise.all(trackIds.map(id =>
      ...
      playBtn.innerHTML = `
        <img src="stop_square_icon_206305.png" width="20" height="20"
             style="margin-left:0;vertical-align:middle;" alt="Stop All">
      `;

      // reset UI after the longest track finishes
